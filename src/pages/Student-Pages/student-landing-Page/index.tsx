...
// import SectionGrid from '../../components/student-section-grid'
...
//     items: [
//       { title: 'Live Projects', subtitle: 'Step into the professional world',img : slive  },
//       { title: 'Internships', subtitle: 'Step into project-based learning',img : internships },
//       { title: 'Research', subtitle: 'Explore new ideas and innovations',img :sresearch  },
//     ],
//   },
//   {
//     id: 'upskill',
...
//     subtitle:
//       'Expand your skillset and stay ahead in a competitive world. Join a community where learning never stops and growth is constant.',
//     items: [
//       { title: 'IOT Coursera', subtitle: '',img : iot },
//       { title: 'Personality', subtitle: '',img: personality},
//       { title: 'Prompt Engineering', subtitle: '',img :prompting  },
//     ],
//   },
//   {
//     id: 'startup',
//     title: 'Build your startup Buisness',
//     subtitle:
//       "Turn your ideas into impact with the right tools and guidance. Start strong, scale fast, and shape the future on your terms.",
//     items: [
//       { title: 'Join a Startup', subtitle: '',img : sjoin },
//       { title: 'Build your Startup', subtitle: '',img : sbuild },
//       { title: 'Pitch to Startup', subtitle: '',img : spitch },
//     ],
//   },
//   {
//     id: 'learn',
...
//     subtitle:
//       'Gain insights from top industry leaders and experts. Accelerate your growth with real-world knowledge and mentorship.',
//     items: [
//       { title: 'Mentorship', subtitle: '',img : smentor },
//       { title: 'Guest Lecture', subtitle: '',img : sguest },
//       { title: 'Product Demos', subtitle: '',img : sproduct },
//     ],
//   },
//   {
//     id: 'compete',
...
//     items: [
//       { title: 'Hackathon', subtitle: '',img : shack },
//       { title: 'Ideation', subtitle: '',img : sidea },
//       { title: 'B-Plan', subtitle: '',img : splan },
//     ],
//   },
// ]
...
//         {sections.map((s) => (
//           <SectionGrid key={s.id} id={s.id} title={s.title} subtitle={s.subtitle} items={s.items} />
//         ))}

//         <section className="py-16">
//           <h2 className="text-3xl font-extrabold text-gray-900">Add value, Get recognized</h2>
