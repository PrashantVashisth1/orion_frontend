...
//   return (
//     <div className="relative bg-blue-50 cursor-pointer rounded-2xl p-6 shadow-lg border border-gray-200 overflow-hidden transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:border-blue-600 hover:bg-blue-100 group flex flex-col h-full">
//       {/* Background Gradient Effect */}
//       <div 
...
//         <div className="flex justify-between items-start mb-4">
//           <div className="flex items-center space-x-4">
//             <div className={`w-12 h-12 rounded-full flex items-center justify-center ${info.iconBg} border-2 border-gray-100 shadow-sm`}>
//               <Icon className={`h-6 w-6 ${info.iconColor}`} />
//             </div>
//             <div>
//               <p className="text-xs text-gray-500 font-medium">Company</p>
//               <h3 className="text-lg font-bold text-emerald-700 mt-1">{need.companyName}</h3>
//             </div>
//           </div>
//           <Badge className={`text-xs font-medium ${info.badgeClass}`}>{info.label}</Badge>
//         </div>
...
//         {/* Body */}
//         <div className="flex-grow">
//           <h2 className="text-2xl font-bold text-gray-900 mt-1 mb-2">{need.title}</h2>
//           <p className="text-sm text-gray-600 mb-6 leading-relaxed line-clamp-2">{need.description}</p>
...
//               <div className="flex flex-nowrap gap-2 overflow-hidden"> 
//                 {skills.slice(0, 3).map((skill, index) => (
//                   <Badge key={index} variant="secondary" className="bg-emerald-200 text-black py-1 border border-gray-200 text-xs whitespace-nowrap">
//                     {skill}
//                   </Badge>
//                 ))}
//                 {skills.length > 3 && (
//                   <Badge variant="secondary" className="bg-emerald-200 text-black border border-gray-200 text-xs whitespace-nowrap">
//                     +{skills.length - 3} more
//                   </Badge>
//                 )}
//               </div>
...
//         {/* Footer */}
//         <div className="flex items-center justify-between text-gray-600 text-sm mt-4 pt-4 border-t border-gray-100">
//           <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-2 sm:space-y-0">
//             {need.location && (
//               <div className="flex items-center space-x-2">
//                 <MapPin className="w-4 h-4 text-blue-500" />
//                 <span className="font-medium text-gray-900">{need.location}</span>
//               </div>
//             )}
//             {need.duration && (
//               <div className="flex items-center space-x-2">
//                 <Calendar className="w-4 h-4 text-emerald-500" />
//                 <span className="font-medium text-gray-900">{need.duration}</span>
//               </div>
//             )}
//           </div>
...
//             <button 
//               onClick={() => onViewClick(need)}
//               className={`px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-full hover:from-purple-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg flex items-center space-x-2 text-xs sm:text-sm`}
//             >
...
//       userId: 1,
//       description: 'Looking for a passionate full-stack developer to join our team and work on exciting projects.',
//       companyName: 'Tech Innovations Inc.',
//       location: 'Mumbai, India',
//       duration: '3-6 months',
//       skills: 'React, Node.js, MongoDB, TypeScript',
//       compensation: '₹15,000/month',
//       projectTeamSize: '5-10',
//       contactInfo: { email: 'hr@techinnovations.com', phone: '+91 98765 43210' },
//       details_json: {}
//     },
//     {
//       id: 2,
...
//       userId: 2,
//       description: 'Build a modern e-commerce platform with payment integration and real-time inventory management.',
...
//       compensation: '₹50,000',
//       projectTeamSize: '3-5',
//       contactInfo: { email: 'projects@retailtech.com', phone: '+91 98765 43211' },
//       details_json: {}
//     },
//     {
//       id: 3,
...
//       userId: 1,
//       description: 'Research on optimizing deep learning models for edge devices with limited computational resources.',
...
//       projectTeamSize: '2-3',
//       contactInfo: { email: 'research@ailabs.com', phone: '+91 98765 43212' },
//       details_json: {}
//     }
//   ];

//   const handleView = (need: Need) => {
//     alert(`Viewing: ${need.title}`);
//   };

//   const handleEdit = (need: Need) => {
//     alert(`Editing: ${need.title}`);
//   };

//   const handleDelete = (need: Need) => {
//     alert(`Deleting: ${need.title}`);
//   };

//   return (
//     <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8">
//       <div className="max-w-7xl mx-auto">
//         <h1 className="text-4xl font-bold text-gray-900 mb-8">Premium Light Cards</h1>
