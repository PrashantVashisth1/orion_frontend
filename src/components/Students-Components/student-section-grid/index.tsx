      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
        {items.map((it) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-end">
              <div className="w-full p-4 bg-gradient-to-t from-slate-900/70 to-transparent text-white">
                <h3 className="text-lg font-bold inline-block bg-white/30 backdrop-blur-md text-gray-900 px-2 py-1 rounded-md shadow-sm">
                  {it.title}
                </h3>
                {it.subtitle && (
                  <p className="text-base font-medium opacity-90 mt-1">{it.subtitle}</p>
                )}
              </div>
            </div>
          </article>
