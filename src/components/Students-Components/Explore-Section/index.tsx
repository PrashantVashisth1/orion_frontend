...
import Navigation from "@/components/Students-Components/StudentPostLoginNavbar";
  ...
  if (error) {
    return (
      <div className="bg-gradient-to-br from-slate-50 via-white to-slate-50 min-h-screen">
        <Navigation onSidebarToggle={false} />
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          <Button
                            ...
                            className="text-purple-600 hover:text-purple-700 hover:bg-purple-50 px-2 py-1 h-auto font-medium border border-purple-300"
                          >
                            SnapShot
                          ...
                          <Button
                            ...
                            className="text-blue-600 border-blue-200 hover:text-blue-700 hover:bg-blue-50 px-2 py-1 h-auto font-medium"
                          >
                            Explore
                          </Button>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      {selectedStartup.achievements.map((achievement, index) => (
                        <div
                          ...
                          className="bg-slate-50 border border-slate-200 p-3 rounded-lg text-center hover:shadow-sm transition-all"
                        >
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-slate-100">
                  {selectedStartup.website && (
                    <Button 
                      ...
                      className="flex-1 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white shadow-sm"
                    >
                  ...
                  {selectedStartup.email && (
                    <Button
                      ...
                      variant="outline"
                      className="flex-1 border-slate-300 text-slate-700 hover:bg-slate-100 hover:text-slate-900 bg-transparent"
                    >
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="flex-1 border-blue-600 text-blue-600 hover:bg-blue-50 hover:text-blue-700 bg-transparent"
                  >
