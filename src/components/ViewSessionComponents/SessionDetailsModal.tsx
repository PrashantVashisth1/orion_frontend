...
//   // --- Conditional Grouping Logic (based on form schema) ---
...
//               {/* --- 1. HOST & CONTACT DETAILS (Fallback, if provided) --- */}
...
//                       <span className="font-semibold text-white">Name:</span> {session.speakerName}
//                     </div>
//                   )}
//                   {session.speakerEmail && (
//                     <div className="flex items-center text-sm ml-6">
//                       <Mail className="w-4 h-4 text-slate-400 mr-2" /> {session.speakerEmail}
//                     </div>
//                   )}
//                 </div>
//               )}
...
//                         <div className="flex items-center">
//                           <ChevronRight className="w-4 h-4 text-slate-500 mr-2" />
//                           <span className="font-semibold text-white">Name:</span> {session.panelistName}
//                         </div>
//                       )}
...
//                           <span className="font-semibold text-white text-sm">Bio: </span>
//                           <p className="text-sm text-slate-400">{session.panelistBio}</p>
//                         </div>
//                       )}
//                     </div>
//                   )}
...
//                         <div className="flex items-center">
//                           <ChevronRight className="w-4 h-4 text-slate-500 mr-2" />
//                           <span className="font-semibold text-white">Name:</span> {session.moderatorName}
//                         </div>
//                       )}
...
//                         <div className="mt-1 ml-6">
//                           <span className="font-semibold text-white text-sm">Bio: </span>
//                           <p className="text-sm text-slate-400">{session.moderatorBio}</p>
//                         </div>
//                       )}
//                     </div>
//                   )}
...
//                         <div className="flex items-center">
//                           <ChevronRight className="w-4 h-4 text-slate-500 mr-2" />
//                           <span className="font-semibold text-white">Name:</span> {session.presenterName}
//                         </div>
//                       )}
...
//                       <p className="flex items-center mb-1"><Briefcase className="w-4 h-4 text-slate-500 mr-2" /> <span className="font-semibold text-white">About the Company:</span></p>
...
//                       <p className="flex items-center mb-1"><FileText className="w-4 h-4 text-slate-500 mr-2" /> <span className="font-semibold text-white">About the Solution/Product:</span></p>
...
//               {/* --- 5. REGISTRATION LINK (Always at the bottom) --- */}
