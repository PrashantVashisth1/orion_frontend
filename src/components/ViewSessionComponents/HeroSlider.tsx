...
//   const navigate = useNavigate();
//   const slides: SlideData[] = [
//     { id: 1, image: "https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=2074&q=80", alt: "Tech entrepreneur presenting" },
//     { id: 2, image: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&w=2074&q=80", alt: "Business meeting discussion" },
//     { id: 3, image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=2074&q=80", alt: "Startup team collaboration" },
//     { id: 4, image: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=2074&q=80", alt: "Innovation workshop" },
//     { id: 5, image: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?auto=format&fit=crop&w=2074&q=80", alt: "AI and machine learning session" },
//     { id: 6, image: "https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?auto=format&fit=crop&w=2074&q=80", alt: "Digital transformation workshop" },
//   ]
...
//   return (
//     <section className="relative bg-gradient-to-br from-white via-gray-100 to-gray-200 py-20 overflow-hidden">
//       {/* Soft Background Glow */}
//       <div className="absolute inset-0 opacity-20 overflow-hidden">
//         <div className="absolute top-0 left-0 w-96 h-96 bg-purple-300 rounded-full blur-3xl transform -translate-x-48 -translate-y-48"></div>
//         <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-300 rounded-full blur-3xl transform translate-x-48 translate-y-48"></div>
//       </div>
...
//           {/* Left - Text Content */}
//           <div className="text-center lg:text-left order-1">
//             <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-emerald-600 mb-6 leading-tight">
//               Explore What's New in Tech, Business, and Beyond
//             </h1>
//             <p className="text-xl text-gray-500 mb-8 font-semibold leading-relaxed max-w-2xl">
//               Trending Talks Across All Domains
//             </p>
//             <div className="mb-8">
...
//                   className="bg-gradient-to-r from-purple-500 to-blue-500 text-white px-10 py-4 rounded-xl text-lg font-medium hover:from-purple-600 hover:to-blue-600 transition-all duration-300 inline-flex items-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
//                 >
//                   Host Session
...
//                       style={{
//                         transform: `
//                           translateX(${position === 0 ? 0 : position === 1 ? 40 : position === slides.length - 1 ? -40 : position < slides.length / 2 ? 80 : -80}px)
//                           scale(${position === 0 ? 1.1 : position === 1 || position === slides.length - 1 ? 0.95 : 0.75})
//                         `,
...
//                       }}
//                     >
//                       <div className="w-full h-full rounded-3xl overflow-hidden shadow-xl border-4 border-gray-300 bg-white">
//                         <img src={slide.image} alt={slide.alt} className="w-full h-full object-cover rounded-3xl" />
