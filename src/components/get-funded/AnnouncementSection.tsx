        ...
        <CardContent className="p-8">
          <div className="mb-8 border-b border-slate-100 pb-6">
            ...
            <p className="text-slate-500 ml-1">
              Stay updated with the latest funding opportunities and investor news
            </p>
          </div>
            ...
            {sampleAnnouncements.length > 0 ? (
              sampleAnnouncements.map((announcement) => (
                <Card
                  ...
                  className="bg-white border-slate-200 transition-all duration-300 hover:border-blue-200 hover:shadow-md group"
                >
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between">
                      <div className="space-y-3 w-full">
                        ...
                        {announcement.investor && (
                          <div className="pt-2">
                            <Button
                              variant="link"
                              // Changed link to Blue
                              className="p-0 h-auto text-blue-600 hover:text-blue-800 font-semibold"
                              onClick={() => window.location.href = announcement.investor!.profileUrl}
                            >
                              View Investor Profile <ArrowRight className="ml-1 h-4 w-4" />
                            </Button>
                          </div>
                        )}
                      </div>
          ...
          <p className="text-sm text-slate-400 mt-8 text-center font-medium">
            New announcements are published regularly. Check back often for updates.
          </p>
        </CardContent>
      </Card>
    </div>
