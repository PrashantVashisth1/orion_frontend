...
import { Briefcase, Users, FlaskConical, Heart, Sparkles } from "lucide-react";
  ...
  <div className="relative bg-white border-b border-slate-100">
    ...
    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between px-8 py-8 gap-6">
      <div className="flex items-center space-x-5">
        <div className="w-16 h-16 bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-200">
        ...
        <div>
          ...
          <p className="text-slate-500 text-lg mt-1">
            Connect with top talent and grow your ecosystem
          </p>
        </div>
      </div>
    </div>
        ...
        return (
          <button
            ...
            className={`
              ...
              flex items-center justify-center space-x-2 border-b-2 whitespace-nowrap
              ${isActive 
