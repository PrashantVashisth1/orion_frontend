      ...
      <Card className="w-[800px] mx-auto bg-white text-slate-900 shadow-md border border-slate-200 transition-none">
        <CardHeader className="bg-gradient-to-r from-blue-500 to-blue-600 p-6 rounded-t-xl text-white">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-3xl font-bold">Offerings of Company</h2>
              <p className="text-sm text-purple-100">Define your company's products, services, and offerings</p>
            </div>
          </div>
        </CardHeader>
        <CardContent className="p-6 space-y-8 bg-white">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <Label className="text-slate-700">Product Offerings</Label>
                <Button onClick={() => addItem('products')} className="bg-blue-600 text-white hover:bg-blue-700 shadow-sm cursor-pointer">
                  <Plus className="w-4 h-4 mr-2" />
                  Add Product
                </Button>
              </div>
              ...
              {formData.products.map((product, index) => (
                <div key={`product-${index}`} className="flex items-center gap-2">
                  <Input
                    ...
                    value={product}
                    onChange={(e) => handleItemChange('products', index, e.target.value)}
                    className="bg-white border-slate-200 text-slate-900 flex-grow placeholder:text-slate-400 focus:border-blue-500"
                  />
                  <Button
                    variant="ghost"
                    size="icon"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <Label className="text-slate-700">Service Offerings</Label>
                <Button onClick={() => addItem('services')} className="bg-blue-600 text-white hover:bg-blue-700 shadow-sm cursor-pointer">
                  <Plus className="w-4 h-4 mr-2" />
                  Add Service
                </Button>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="pricing-model" className="text-slate-700">
                  Pricing Model
                </Label>
                <Input
                  id="pricing-model"
              ...
              <div className="space-y-2">
                <Label htmlFor="business-model" className="text-slate-700">
                  Business Model
                </Label>
                <Input
                  id="business-model"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="value-proposition" className="text-slate-700">
                Value Proposition
              </Label>
              <Textarea
                id="value-proposition"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="competitive-advantage" className="text-slate-700">
                Competitive Advantage
              </Label>
              <Textarea
                id="competitive-advantage"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <Label className="text-slate-700">Revenue Sources</Label>
                <Button onClick={() => addItem('revenueStreams')} className="bg-blue-600 text-white hover:bg-blue-700 shadow-sm cursor-pointer">
                  <Plus className="w-4 h-4 mr-2" />
                  Add Revenue Stream
                </Button>
              </div>
              {formData.revenueStreams.length === 0 && (
                <p className="text-sm text-slate-500">No revenue streams added yet.</p>
              )}
              {formData.revenueStreams.map((stream, index) => (
                <div key={`revenue-${index}`} className="flex items-center gap-2">
                  <Input
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <Label className="text-slate-700">Strategic Partnerships</Label>
                <Button onClick={() => addItem('partnerships')} className="bg-blue-600 text-white hover:bg-blue-700 shadow-sm cursor-pointer">
                  <Plus className="w-4 h-4 mr-2" />
                  Add Partnership
                </Button>
              </div>
              {formData.partnerships.length === 0 && (
                <p className="text-sm text-slate-500">No partnerships added yet.</p>
              )}
              {formData.partnerships.map((partnership, index) => (
                <div key={`partnership-${index}`} className="flex items-center gap-2">
                  <Input
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <Label className="text-slate-700">Certifications & Awards</Label>
                <Button onClick={() => addItem('certifications')} className="bg-blue-600 text-white hover:bg-blue-700 shadow-sm cursor-pointer">
                  <Plus className="w-4 h-4 mr-2" />
                  Add Certification
                </Button>
              </div>
              ...
              {formData.certifications.map((certification, index) => (
                <div key={`certification-${index}`} className="flex items-center gap-2">
                  <Input
                    ...
                    value={certification}
                    onChange={(e) => handleItemChange('certifications', index, e.target.value)}
                    className="bg-white border-slate-200 text-slate-900 flex-grow placeholder:text-slate-400 focus:border-purple-500"
                  />
                  <Button
                    variant="ghost"
                    size="icon"
          ...
          <div className="flex justify-end pt-6">
            <Button
              onClick={handleSubmit}
              disabled={!isFormValid || isLoading}
              className="bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-600 text-white font-semibold py-3 px-8 rounded-xl shadow-md transform hover:scale-101 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
              {isLoading ? (
                <div className="flex items-center space-x-2">
                  <Loader2 className="w-4 h-4 animate-spin" />
