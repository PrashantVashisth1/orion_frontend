        ...
        <CardContent className="p-6 space-y-8 bg-white">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="founded-year" className="text-slate-700">
                  Founded Year *
                </Label>
                <Input
                  id="founded-year"
              ...
              <div className="space-y-2">
                <Label htmlFor="company-email" className="text-slate-700">
                  Company Email *
                </Label>
                <Input
                  id="company-email"
              ...
              <div className="space-y-2">
                <Label htmlFor="company-phone" className="text-slate-700">
                  Company Phone *
                </Label>
                <Input
                  id="company-phone"
              ...
              <div className="space-y-2">
                <Label htmlFor="company-location" className="text-slate-700">
                  Company Location 
                </Label>
                <Input
                  id="company-location"
              ...
              <div className="space-y-2">
                <Label htmlFor="company-website" className="text-slate-700">
                  Company Website 
                </Label>
                <Input
                  id="company-website"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="company-type" className="text-slate-700">
                  Company Type
                </Label>
                <Input
                  id="company-type"
              ...
              <div className="space-y-2">
                <Label htmlFor="revenue-range" className="text-slate-700">
                  Revenue Range
                </Label>
                <Input
                  id="revenue-range"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="tax-id" className="text-slate-700">
                  Tax ID 
                </Label>
                <Input
                  id="tax-id"
              ...
              <div className="space-y-2">
                <Label htmlFor="registration-date" className="text-slate-700">
                  Registration Date 
                </Label>
                <Input
                  id="registration-date"
              ...
              <div className="space-y-2">
                <Label htmlFor="business-license" className="text-slate-700">
                  CIN Number 
                </Label>
                <Input
                  id="business-license"
