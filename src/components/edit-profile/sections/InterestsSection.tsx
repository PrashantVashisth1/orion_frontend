...
export default function InterestsSection({
      ...
      setFormData(() => ({
        ...
        innovationFocus: {
          ...
          sustainabilityInnovation:
            innovation.sustainabilityInnovation ?? false,
          socialImpact: innovation.socialImpact ?? false,
          disruptiveTechnology: innovation.disruptiveTechnology ?? false,
          innovationDescription: innovation.innovationDescription || "",
        },
  ...
  const handleTechnologyChange = (
    tech: keyof typeof formData.technologyInterests,
    checked: boolean
  ) => {
    setFormData((prev) => ({
      ...prev,
  ...
  const handlePartnershipChange = (
    partnership: keyof typeof formData.partnershipInterests,
    checked: boolean
  ) => {
    setFormData((prev) => ({
      ...prev,
  ...
  const handleInnovationChange = (
    innovation: keyof typeof formData.innovationFocus,
    checked: boolean
  ) => {
    setFormData((prev) => ({
      ...prev,
  ...
  const handleNestedTextChange = (
    section: "technologyInterests" | "innovationFocus",
    field: string,
    value: string
  ) => {
    setFormData((prev) => ({
    ...
    try {
      const combinedData = {
        ...
        enterprise_partnerships:
          formData.partnershipInterests.enterprisePartnerships,
        research_collaborations:
          formData.partnershipInterests.researchCollaborations,
        academic_partnerships:
          formData.partnershipInterests.academicPartnerships,
        government_contracts: formData.partnershipInterests.governmentContracts,
        nonprofit_collaborations:
          formData.partnershipInterests.nonprofitCollaborations,

        // InnovationFocus Fields (Booleans + Description)
        product_development: formData.innovationFocus.productDevelopment,
        process_innovation: formData.innovationFocus.processInnovation,
        business_model_innovation:
          formData.innovationFocus.businessModelInnovation,
        sustainability_innovation:
          formData.innovationFocus.sustainabilityInnovation,
        social_impact: formData.innovationFocus.socialImpact,
        disruptive_technology: formData.innovationFocus.disruptiveTechnology,
      };
      ...
      <Card className="w-[800px] mx-auto bg-white text-slate-900 shadow-md border border-slate-200 transition-none">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-purple-100">
                Define your company's interests, focus areas, and strategic
                priorities
              </p>
            </div>
          </div>
        ...
        <CardContent className="p-6 space-y-8 bg-white">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="primary-industry" className="text-slate-700">
                  Primary Industry *
                </Label>
                <Input
                  id="primary-industry"
                  ...
                  value={formData.primaryIndustry}
                  onChange={(e) =>
                    handleInputChange("primaryIndustry", e.target.value)
                  }
                  className="bg-white border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-purple-500"
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="secondary-industry" className="text-slate-700">
                  Secondary Industry
                </Label>
                <Input
                  id="secondary-industry"
                  ...
                  value={formData.secondaryIndustry || ""}
                  onChange={(e) =>
                    handleInputChange("secondaryIndustry", e.target.value)
                  }
                  className="bg-white border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-purple-500"
                />
              </div>
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleTechnologyChange("aiMl", checked as boolean)
                    }
                    className="
    h-5 w-5
    rounded-md
  ...
  "
                  />
                  <Label htmlFor="ai-ml" className="text-slate-700">
                    AI & Machine Learning
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    checked={formData.technologyInterests.blockchain}
                    onCheckedChange={(checked) =>
                      handleTechnologyChange("blockchain", checked as boolean)
                    }
                    className="
    h-5 w-5
    rounded-md
  ...
  "
                  />
                  <Label htmlFor="blockchain" className="text-slate-700">
                    Blockchain
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
  ...
  "
                  />
                  <Label htmlFor="cloud-computing" className="text-slate-700">
                    Cloud Computing
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
  ...
  "
                  />
                  <Label htmlFor="cybersecurity" className="text-slate-700">
                    Cybersecurity
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    checked={formData.technologyInterests.iot}
                    onCheckedChange={(checked) =>
                      handleTechnologyChange("iot", checked as boolean)
                    }
                    className="
    h-5 w-5
    rounded-md
  ...
  "
                  />
                  <Label htmlFor="iot" className="text-slate-700">
                    IoT
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    checked={formData.technologyInterests.fintech}
                    onCheckedChange={(checked) =>
                      handleTechnologyChange("fintech", checked as boolean)
                    }
                    className="
    h-5 w-5
    rounded-md
  ...
  "
                  />
                  <Label htmlFor="fintech" className="text-slate-700">
                    FinTech
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    checked={formData.technologyInterests.healthtech}
                    onCheckedChange={(checked) =>
                      handleTechnologyChange("healthtech", checked as boolean)
                    }
                    className="
    h-5 w-5
    rounded-md
  ...
  "
                  />
                  <Label htmlFor="healthtech" className="text-slate-700">
                    HealthTech
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    checked={formData.technologyInterests.edtech}
                    onCheckedChange={(checked) =>
                      handleTechnologyChange("edtech", checked as boolean)
                    }
                    className="
    h-5 w-5
    rounded-md
  ...
  "
                  />
                  <Label htmlFor="edtech" className="text-slate-700">
                    EdTech
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
  ...
  "
                  />
                  <Label htmlFor="sustainability" className="text-slate-700">
                    Sustainability Tech
                  </Label>
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="other-tech" className="text-slate-700">
                  Other Technology Interests
                </Label>
                <Input
                  id="other-tech"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="target-market" className="text-slate-700">
                    Primary Target Market
                  </Label>
                  <Input
                    id="target-market"
                    ...
                    value={formData.primaryTargetMarket}
                    onChange={(e) =>
                      handleInputChange("primaryTargetMarket", e.target.value)
                    }
                    className="bg-white border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-purple-500"
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="geographic-focus" className="text-slate-700">
                    Geographic Focus
                  </Label>
                  <Input
                    id="geographic-focus"
              ...
              <div className="space-y-2">
                <Label htmlFor="market-description" className="text-slate-700">
                  Market Description
                </Label>
                <Textarea
                  id="market-description"
                  ...
                  value={formData.marketDescription || ""}
                  onChange={(e) =>
                    handleInputChange("marketDescription", e.target.value)
                  }
                  className="bg-white border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-purple-500"
                />
              </div>
  ...
  "
                  />
                  <Label
                    htmlFor="enterprise-partnerships"
                    className="text-slate-700"
                  >
  ...
  "
                  />
                  <Label
                    htmlFor="research-collaborations"
                    className="text-slate-700"
                  >
  ...
  "
                  />
                  <Label
                    htmlFor="nonprofit-collaborations"
                    className="text-slate-700"
                  >
              ...
              <div className="space-y-2">
                <Label htmlFor="partnership-goals" className="text-slate-700">
                  Partnership Goals
                </Label>
                <Textarea
                  id="partnership-goals"
  ...
  "
                  />
                  <Label
                    htmlFor="business-model-innovation"
                    className="text-slate-700"
                  >
  ...
  "
                  />
                  <Label
                    htmlFor="sustainability-innovation"
                    className="text-slate-700"
                  >
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    checked={formData.innovationFocus.socialImpact}
                    onCheckedChange={(checked) =>
                      handleInnovationChange("socialImpact", checked as boolean)
                    }
                    className="
    h-5 w-5
    rounded-md
  ...
  "
                  />
                  <Label htmlFor="social-impact" className="text-slate-700">
                    Social Impact
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
  ...
  "
              ...
              <div className="space-y-2">
                <Label
                  htmlFor="innovation-description"
                  className="text-slate-700"
                >
                  Innovation Focus Description
                </Label>
                <Textarea
                  ...
                  value={formData.innovationDescription || ""}
                  onChange={(e) =>
                    handleInputChange("innovationDescription", e.target.value)
                  }
                  className="bg-white border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-purple-500"
                />
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="future-goals" className="text-slate-700">
                Long-term Goals
              </Label>
              <Textarea
                id="future-goals"
                ...
                value={formData.futureGoals || ""}
                onChange={(e) =>
                  handleInputChange("futureGoals", e.target.value)
                }
                className="bg-white border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-purple-500"
              />
            </div>
